...
export const SignIn = () => {
  ...
  const { showPassword, toggleShowPassword } = useEmployeeStore();
      ...
      >
        ...
        <div className=" flex relative w-full flex-col">
          ...
          <button
            ...
            className="flex items-center justify-center p-2 absolute top-1 right-1"
          >
            <Eye className="text-gray-500" />
          </button>
          {errors.password && (
            <p className=" mt-1 flex text-center text-red-600 text-sm">
